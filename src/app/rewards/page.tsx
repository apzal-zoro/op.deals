    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="text-center">
          <h1 className="text-2xl font-headline text-primary">Loyalty Rewards</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {mockRewards.map((reward) => (
            <Card key={reward.id} className="text-center flex flex-col items-center justify-between p-4 pixel-corners bg-card/80">
              <CardHeader>
                ...
                <CardTitle className="font-headline text-lg mt-4">{reward.title}</CardTitle>
              </CardHeader>
              <CardContent className="flex-grow"></CardContent>
              <Button className="w-full font-headline text-xs pixel-corners-sm hover:shadow-glow-primary">
